    ...
    <div style={{ minHeight: '100vh', background: '#e8e8e8', color: '#111111', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: '#003366', color: 'white', padding: '8px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '2px solid #cc6600' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontWeight: 'bold', fontSize: 14 }}>DI Mock Exam Portal</div>
            <div style={{ fontSize: 11, color: '#aac4ff' }}>Data Interpretation</div>
          </div>
        </div>
        <div style={{ fontSize: 13, color: '#aac4ff' }}>Set {testId}</div>
      </div>

      {/* Title bar */}
      <div style={{ background: '#0052cc', padding: '10px 16px', textAlign: 'center' }}>
        <div style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>Data Interpretation — Set {testId}</div>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ background: 'white', padding: '20px 24px', border: '1px solid #ccc', fontSize: 13, lineHeight: 1.7 }}>
            ...
            <ol style={{ paddingLeft: 24, margin: 0 }}>
              <li style={{ marginBottom: 10 }}>This is a <strong>Data Interpretation</strong> set built from one or more <strong>data sets</strong> (charts, tables and caselets), each followed by a group of questions.</li>
              <li style={{ marginBottom: 10 }}>The test duration (shown on the set card, roughly two and a half minutes per question) is tracked by the countdown timer (&ldquo;Time Left&rdquo;) at the top-right of the screen.</li>
              ...
              <li style={{ marginBottom: 10 }}>Every question is a <strong>Multiple-Choice Question (MCQ)</strong>, of which exactly one option is correct.</li>
              ...
              <li style={{ marginBottom: 10 }}>The relevant chart / table / caselet is shown above each question; questions from the same data set appear consecutively. An on-screen <strong>calculator</strong> is available.</li>
            ...
            <ol start={9} style={{ paddingLeft: 24, margin: 0 }}>
              ...
              <li style={{ marginBottom: 10 }}>After you submit, you can review every question with the correct answer and a detailed explanation.</li>
            </ol>
          </div>
...
export default function DiInstructionsPage() {
  return (
