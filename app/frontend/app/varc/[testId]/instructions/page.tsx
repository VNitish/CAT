...
function VarcInstructionsInner() {
    ...
    <div style={{ minHeight: '100vh', background: '#e8e8e8', color: '#111111', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ background: '#003366', color: 'white', padding: '8px 16px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: '2px solid #cc6600' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div>
            <div style={{ fontWeight: 'bold', fontSize: 14 }}>VARC Mock Exam Portal</div>
            <div style={{ fontSize: 11, color: '#aac4ff' }}>Verbal Ability & Reading Comprehension</div>
          </div>
        </div>
        <div style={{ fontSize: 13, color: '#aac4ff' }}>Section Test {testId}</div>
      </div>

      {/* Title bar */}
      <div style={{ background: '#0052cc', padding: '10px 16px', textAlign: 'center' }}>
        <div style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>VARC Section Test {testId}</div>
        ...
        <div style={{ maxWidth: 900, margin: '0 auto' }}>
          ...
          <div style={{ background: 'white', padding: '20px 24px', border: '1px solid #ccc', fontSize: 13, lineHeight: 1.7 }}>
            ...
            <ol style={{ paddingLeft: 24, margin: 0 }}>
              <li style={{ marginBottom: 10 }}>This is a single-section test of <strong>Verbal Ability &amp; Reading Comprehension (VARC)</strong> with <strong>34 questions</strong>.</li>
              <li style={{ marginBottom: 10 }}>The total duration of the test is <strong>60 minutes</strong>. The countdown timer (&ldquo;Time Left&rdquo;) appears at the top-right of the screen.</li>
              <li style={{ marginBottom: 10 }}><strong>The clock does not auto-submit.</strong> When the timer reaches zero it will continue counting into negative time so you can see how far over you have run. Submit whenever you are ready.</li>
              <li style={{ marginBottom: 10 }}>The paper includes Multiple-Choice Questions (MCQs) with options and Non-MCQs (parajumbles requiring a typed sequence).</li>
              <li style={{ marginBottom: 10 }}>For an MCQ, you receive <strong>+3 marks</strong> for a correct answer, <strong>&minus;1 mark</strong> for a wrong answer, and <strong>0 marks</strong> for an unattempted question.</li>
              <li style={{ marginBottom: 10 }}>For a Non-MCQ (parajumble), you receive <strong>+3 marks</strong> for a correct answer and <strong>0 marks</strong> for a wrong or unattempted question &mdash; there is <strong>no negative marking</strong>.</li>
            ...
            <ol start={9} style={{ paddingLeft: 24, margin: 0 }}>
              ...
              <li style={{ marginBottom: 10 }}>For a parajumble question, type the order of the labelled sentences (e.g. <strong>CBADE</strong>) in the answer box.</li>
              <li style={{ marginBottom: 10 }}>An on-screen calculator is available, though it is rarely needed for VARC.</li>
            </ol>
          </div>
...
export default function VarcInstructionsPage() {
  return (
